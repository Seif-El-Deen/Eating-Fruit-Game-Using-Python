...
def display_score():
    font = pygame.font.Font("Sevillana-Regular.ttf", 36)
    #                                                                  R    G    B
...
def display_remaining_time():
    ...
    text = font.render("Player Score: {}".format(5 - time_counter), True, (12, 245, 39))
    # print(time_counter)
...
app_icon = pygame.image.load(r"apple.png")
...
my_player = pygame.image.load(r"player.png")

my_fruit = pygame.image.load(r"apple.png")
